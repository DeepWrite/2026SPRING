...
<script>
  ...
  function asmt09Template(name, classNo, serialNo) {
    const navOrder = String(parseInt(serialNo, 10) || serialNo).trim();
    const head = `---
title: ${classNo}-${serialNo} ${name} (과제-09)
layout: home
nav_order: ${navOrder}
parent: 과제-09 기말과제 최종본
permalink: /asmt-09/${classNo}-${serialNo}
---

# (최종본) 과제-09 기말과제 ${classNo}-${serialNo} ${name} 
`;
...
`;
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    btn.addEventListener("click", () => {
      ...
      const content = asmt09Template(name, classNo, serialNo);
