...
<script>
  ...
  function asmt08Template(name, classNo, serialNo) {
    const navOrder = String(parseInt(serialNo, 10) || serialNo).trim();
    const head = `---
title: ${classNo}-${serialNo} ${name} (과제-08)
layout: home
nav_order: ${navOrder}
parent: 과제-08 기말과제 초고 작성하기
permalink: /asmt-08/${classNo}-${serialNo}
---

# (초고) 과제-08 기말과제 초고 작성하기 ${classNo}-${serialNo} ${name} 
`;
...
`;
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    btn.addEventListener("click", () => {
      ...
      const content = asmt08Template(name, classNo, serialNo);
