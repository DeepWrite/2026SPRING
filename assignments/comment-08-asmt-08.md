...
[eTL 과제함: (테이크홈) (Comment)[코멘트-08] 조원 3인의 과제-08에 대한 코멘트](https://myetl.snu.ac.kr/){: .btn .btn-primary }
...
- **코멘트 양식 주의사항 1**: **파일명**과 양식의 **title** 부분에서 **`c`** 에 해당하는 정보
  - `title: 015-33 홍길동의 코멘트c (과제-08)` 부분과, 파일명 `comment-08-015-33c-홍길동.md`에서 `c`에 해당하는 정보는, 코멘트 대상 **조원의 연번 오름차순**으로 각각 `a`, `b`, `c` 순서로 변경.  
  - (예시) 015반인 나의 이름이 `33 홍길동`이고, 코멘트를 해주어야 할 친구의 연번과 이름이 각각 `23 친구가`, `04 친구나`, `11 친구다`인 경우 코멘트 `파일명`과 `title: `은 각각,
    - **23 친구가**에 대하여 **c**: `comment-08-015-33c-홍길동.md`, `title: 015-33 홍길동의 코멘트c (과제-08)`
    - **04 친구나**에 대하여 **a**: `comment-08-015-33a-홍길동.md`, `title: 015-33 홍길동의 코멘트a (과제-08)`
    - **11 친구다**에 대하여 **b**: `comment-08-015-33b-홍길동.md`, `title: 015-33 홍길동의 코멘트b (과제-08)`
  - 으로 작성하고, 
