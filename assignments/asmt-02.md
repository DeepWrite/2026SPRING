...
# 과제-02 쟁점과 딜레마 분석 (6차시 테이크 홈)

*(작성중)*

## 과제 설명

**3주차 (6차시) 쟁점과 딜레마 분석**: [3주차 (6차시) 쟁점과 딜레마 분석]({{site.baseurl}}/lectures/week03-06)

## 과제 양식

[과제-02 쟁점과 딜레마 분석 템플릿 생성기]({{site.baseurl}}/assignment-generator/asmt-02){: .btn .btn-primary }

- 링크에서 템플릿을 생성하여 작성 후 제출할 것.
- 파일명 유지
