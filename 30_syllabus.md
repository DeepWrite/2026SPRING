...
- 1차시 (오리엔테이션): 본 강좌가 지향하는 기본적 논증문 모델 소개
  - **강의**: [기본 논증문 모델(1주차 1차시)]({{site.baseurl}}/basic-model/lemma)

- 2차시 (강의계획 설명): 강의계획, 논증적 글쓰기에 대한 이론적 이해, 문서작성방법 설명
...
- 3차시 (논증문의 구성요소): 논증문을 구성하는 THESIS와 ARGUMENT의 이해
...
- 4차시 (요약연습)
  ...
  - **강의**: 요약문의 이해 (15분)
  - **과제설명** (5분)
  - (수업 중 마감) **인클래스 과제**: [요약문 작성 연습]({{site.baseurl}}/assignments/asmt-01) (45분)

- 테이크홈 과제 
  - 조원 3인(**조교 지정**)의 요약문 읽고 올 것.(5차시에 코멘트 작성할 수 있도록 준비.)

---

### (3주차) 단락의 구성: 단락 작성 연습 (2026.3.15 ~ 3.21)

- 5차시
  - [3주차 (5차시) 1. 요약본 코멘트]({{site.baseurl}}/lectures/week03-05-01)
  - (수업 중 마감) **조별 코멘트**: [요약문 작성 연습 - 코멘트-01 과제 제출]({{site.baseurl}}/assignments/comment-01-asmt-01) (20분)
    - 요약문의 구성요소에 주의하여 코멘트
...
- 6차시 
  ...
  - (수업 중 마감) **인클래스 과제**: [단문 연습]() (40분)
    ...
    - (**반별로 당일 배포된**) 요약 대상 문헌과 관련하여, 자신의 주장과 근거를 제시하는 단문 작성.
...
### (4주차) 쟁점 및 딜레마 찾기: 리서치 연습 (2026.3.22 ~ 3.28)
